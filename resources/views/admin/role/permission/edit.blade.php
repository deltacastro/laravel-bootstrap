<div class="col-12">
    ...
    <form id="rolePermission-update-form" action="{{ route('admin.role.permission.update', [$role]) }}" method="post">
        @csrf
        @method('PUT')
...
<script>
    ...
    $(function() {
        ...
        $('#rolePermission-update-form').on('submit', function(e) {
            e.preventDefault();
